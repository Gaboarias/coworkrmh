...
import { listProfiles, listTeamMembers } from "@/lib/actions/profiles";
...
export default async function AdminBucketPage({ params }: PageProps) {
  ...
  return (
    <div className="animate-fade-in mx-auto max-w-3xl p-6 md:p-8">
      ...
      <PageHeader
        title={bucket.name}
        description="Perfiles, permisos, responsabilidades y acuerdos"
      />
      <BucketTeamAdmin
        bucketId={bucket.id}
