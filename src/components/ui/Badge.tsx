 ...
 */
const badge = cva(
  "inline-flex items-center gap-1 rounded-sm px-1.5 py-1 font-mono text-[11px] font-medium uppercase tracking-[0.14em] leading-none",
  {
    variants: {
      variant: {
        neutral: "bg-accent-soft text-ink-soft",
        primary: "bg-accent-soft text-ink",
        success: "bg-done-soft text-done-text",
        warning: "bg-warn-soft text-warn-text",
        danger: "bg-urgent-soft text-urgent-text",
